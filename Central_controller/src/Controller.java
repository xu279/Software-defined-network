		...
		*/
        ...
        while (count != total_switch_nums)
        {
        	...
        	if(sentence.contains("REGISTER_REQUEST"))
        	{
        		...
        		logging_file.write("Received REGISTER_REQUEST from ID "+ID+"\n");
        		//update table
        		...
        		logging_file.write("The Register response sent to "+ID+" is " + neighbors.toString()+"\n");
        ...
        while (true)
        {
            ...
            if(sentence.contains("REGISTER_REQUEST"))
            {
        		...
        		//What I send is 
        		System.out.println("What I send to switch "+ID+" is " + neighbors.toString());
        		logging_file.write("The returned Register response sent to "+ID+" is " + neighbors.toString()+"\n");
        		sendData = neighbors.toString().getBytes();
                DatagramPacket sendPacket = new DatagramPacket(sendData, sendData.length, IPAddress, port);
                serverSocket.send(sendPacket);
            }
